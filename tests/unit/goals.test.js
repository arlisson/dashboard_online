...
test('meta aceita somente as categorias preenchidas quando a soma coincide',()=>assert.equal(goalSchema.safeParse({...base,goal_value:'50',morning_value:'',afternoon_value:'',new_base_value:'',new_out_value:''}).success,true));
