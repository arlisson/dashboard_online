...
async function renderSales(db, env, req, res) {
  ...
  res.render('layouts/main', { title: 'Vendas', page: 'pages/sales', result, references, edit, query: req.query, now: nowCommercial(env.APP_TIMEZONE) });
}
